...
### Installation en cours (vue ensemble) 
![Photo de la vue d'ensemble de l'oeuvre *Ocean Rouge*](./photo_palmares)
...
### Installation en cours (vue ensemble) 
![Photo de la vue d'ensemble de l'oeuvre *Ocean Rouge*](./photo_palmares/yeux_croisent_vue_ensemble.png).
